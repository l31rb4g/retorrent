...
function editLink($lid,$newLink,$newSite)
{
    ...
    header("location: admin?op=editLinks");
}
...
function addRSS($newRSS)
{
    ...
    header("location: admin?op=editRSS");
}
...
function addUser($newUser, $pass1, $userType)
{
    ...
    else
    {
        ...
        header("location: admin?op=CreateUser");
    }
}
...
function updateUser($user_id, $org_user_id, $pass1, $userType, $hideOffline)
{
    ...
    if (IsUser($user_id) && ($user_id != $org_user_id))
    {
        ...
        echo "[<a href=\"admin?op=editUser&user_id=".$org_user_id."\">"._RETURNTOEDIT." ".$org_user_id."</a>]</div><br><br><br>";
...
function displayMenu()
{
    ...
    echo "<a href=\"/admin\"><font class=\"adminlink\">"._ADMIN_MENU."</font></a> | ";
    echo "<a href=\"admin?op=configSettings\"><font class=\"adminlink\">"._SETTINGS_MENU."</font></a> | ";
    echo "<a href=\"admin?op=queueSettings\"><font class=\"adminlink\">"._QMANAGER_MENU."</font></a> | ";
    echo "<a href=\"admin?op=searchSettings\"><font class=\"adminlink\">"._SEARCHSETTINGS_MENU."</font></a> | ";
    echo "<a href=\"admin?op=showUserActivity\"><font class=\"adminlink\">"._ACTIVITY_MENU."</font></a> | ";
    echo "<a href=\"admin?op=editLinks\"><font class=\"adminlink\">"._LINKS_MENU."</font></a> | ";
    echo "<a href=\"admin?op=editRSS\"><font class=\"adminlink\">rss</font></a> | ";
    echo "<a href=\"admin?op=CreateUser\"><font class=\"adminlink\">"._NEWUSER_MENU."</font></a> | ";
    echo "<a href=\"admin?op=backupDatabase\"><font class=\"adminlink\">"._BACKUP_MENU."</font></a>";
    echo "</div></td></tr>";
    echo "</table><br>";
...
function displayActivity($min=0, $user="", $srchFile="", $srchAction="")
{
    ...
    if ($prev>=0)
    {
        $prevlink = "<a href=\"admin?op=showUserActivity&min=".$prev."&user_id=".$user."&srchFile=".$srchFile."&srchAction=".$srchAction."\">";
        $prevlink .= "<font class=\"TinyWhite\">&lt;&lt;".$min." "._SHOWPREVIOUS."]</font></a> &nbsp;";
    }
    if ($inx>=$offset)
    {
        $morelink = "<a href=\"admin?op=showUserActivity&min=".$max."&user_id=".$user."&srchFile=".$srchFile."&srchAction=".$srchAction."\">";
...
?>
    ...
    <div align="center">
    <table>
    <form action="admin?op=showUserActivity" name="searchForm" method="post">
    <tr>
        <td>
...
?>
        ...
        <td align="right"><a href="admin?op=showUserActivity&user_id=<?php echo $user_id ?>"><img src="images/properties.png" width="18" height="13" title="<?php echo $user_id."'s "._USERSACTIVITY ?>" border="0"></a></td>
        </tr>
        </table>
<?php
        echo "</td>";
        ...
        {
            echo "<a href=\"admin?op=editUser&user_id=".$user_id."\"><img src=\"images/edit.png\" width=12 height=13 title=\""._EDIT." ".$user_id."\" border=0></a>";
        }
        echo "<img src=\"".$user_image."\" title=\"".$user_id." - ".$type_user."\">";
        if ($user_level <= 1)
        {
            echo "<a href=\"admin?op=deleteUser&user_id=".$user_id."\"><img src=\"images/delete_on.gif\" border=0 width=16 height=16 title=\""._DELETE." ".$user_id."\" onclick=\"return ConfirmDeleteUser('".$user_id."')\"></a>";
        }
        else
        {
...
?>
    ...
    <tr>
        ...
        <tr>
            <td colspan="2" align="center"><div align="center">[<a href="admin?op=showUserActivity&user_id=<?php echo $user_id ?>"><?php echo _USERSACTIVITY ?></a>]</div></td>
        </tr>
        </table>
        </div>
        ...
        <form name="theForm" action="admin?op=updateUser" method="post" onsubmit="return validateUser()">
        <tr>
...
?>
    <div align="center">
        <table cellpadding="5" cellspacing="0" border="0">
        <form name="theForm" action="admin?op=addUser" method="post" onsubmit="return validateProfile()">
        <tr>
            <td align="right"><?php echo _USER ?>:</td>
            <td>
...
?>
    <form action="admin?op=addLink" method="post">
...
<?php
    ...
    ?>
      <form action="admin?op=editLink" method="post">
      <?php echo _FULLURLLINK ?>:
    ...
    <?php
            ...
            {
                echo "<tr><td>";
                echo "<a href=\"admin?op=deleteLink&lid=".$lid."\"><img src=\"images/delete_on.gif\" width=16 height=16 border=0 title=\""._DELETE." ".$lid."\" align=\"absmiddle\"></a>&nbsp;";
                echo "<a href=\"admin?op=editLinks&edit=".$lid."\"><img src=\"images/properties.png\" width=18 height=13 border=0 title=\""._EDIT." ".$lid."\" align=\"absmiddle\"></a>&nbsp;";
                ...
                if ($inx > 1 ){
                    ...
                    echo "<a href='admin?op=moveLink&amp;direction=up&amp;lid=".$lid."'>";
                ...
                if ($inx != count($arLinks)) {
                    ...
                    echo "<a href='admin?op=moveLink&amp;direction=down&amp;lid=".$lid."'>";
...
function editRSS()
{
    ...
    echo "</td></tr><tr><td align=\"center\">";
?>
    <form action="admin?op=addRSS" method="post">
    <?php echo _FULLURLLINK ?>:
...
<?php
    ...
    if(is_array($arLinks))
    {
        ...
        {
            $rid = $arRid[$inx++];
            echo "<tr><td><a href=\"admin?op=deleteRSS&rid=".$rid."\"><img src=\"images/delete_on.gif\" width=16 height=16 border=0 title=\""._DELETE." ".$rid."\" align=\"absmiddle\"></a>&nbsp;";
...
?>
    ...
    <div align="center">
        ...
        <form name="theForm" action="admin?op=updateConfigSettings" method="post" onsubmit="return validateSettings()">
...
function updateConfigSettings()
{
    ...
    header("Location: admin?op=".$continue);
}
...
?>
    <div align="center">
        ...
        <table cellpadding="5" cellspacing="0" border="0" width="100%">
        <form name="theForm" action="admin?op=searchSettings" method="post">
        <tr>
...
<?php
    if (is_file('searchEngines/'.$searchEngine.'Engine.php'))
    {
        ...
        if ($sEngine->initialized)
        {
            ...
            echo "</tr></table></td>";
            echo "<form name=\"theSearchEngineSettings\" action=\"admin?op=updateSearchSettings\" method=\"post\">\n";
...
function updateSearchSettings()
{
    ...
    $searchEngine = getRequestVar('searchEngine');
    if (empty($searchEngine)) $searchEngine = $cfg["searchEngine"];
    header("location: admin?op=searchSettings&searchEngine=".$searchEngine);
}
